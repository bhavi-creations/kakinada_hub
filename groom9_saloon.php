    ...
    <section>
        <div class="container">
            ...
            <div class="text-center   ">
                <h1>Welcome to The  Groom 9 saloon</h1>
                <h5>Experience Luxury & Elegance at  Groom 9 saloon</h5>
            </div>
            <div class="row">
                <div class="col-lg-9 col-12">
                    ...
                    <div class="row my-5 p-3">
                        <div class="col-md-8 col-12 ">
                            <h6>
                             Groom 9 saloon offers a luxurious and relaxing experience where beauty meets expertise. With a team of skilled professionals, we provide a wide range of services, including hair styling, skincare, bridal makeovers, and personalized beauty treatments. Our salon is designed to create a serene atmosphere, ensuring every client leaves feeling refreshed and confident.
