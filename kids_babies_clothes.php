...
<section class=" bg_section responsive_section">
    <div class="container">
        ...
        <div class="text-center   ">
            <h1>Welcome to The Little Twins</h1>
            <h5>Comfort Meets Cuteness – Shop Baby & Kids Fashion</h5>
        </div>
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>The Little Twins</h3>
                            <p class="product-title h5 mt-1">Trendy Outfits for Toddlers to Teens</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        Discover a delightful range of kids' and baby clothes designed to bring comfort, color, and charm to your child's wardrobe. From newborn essentials to playful outfits for growing kids, our collection combines soft fabrics with thoughtful designs

                        </h6>
                        <h6>
                        that move with every giggle, crawl, and adventure. Whether you're dressing up for a special event or need everyday wear, we have everything your little one needs to shine in style
                        </h6>
                    </div>
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Cotton Baby Romper</span>
                                <span class="price"> 	₹399</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Printed T-Shirts (2-Pack)</span>
                                <span class="price">₹599</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Denim Overalls</span>
                                <span class="price"> 	₹849</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Floral Frock</span>
                                <span class="price">₹749</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Hooded Winter Jacket</span>
                                <span class="price">₹1,199</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">Boys’ Formal Shirt & Pants</span>
                                <span class="price">	₹1,299</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Pajama Set (Cartoon Print) </span>
