...
<section class=" bg_section responsive_section">
    <div class="container">
        ...
        <div class="text-center   ">
            <h1>Welcome to The Iron Pulse Fitness Studio</h1>
            <h5>Transform Your Body, Elevate Your Lifestyle</h5>
        </div>
        <div class="row">
        ...
        <?php include 'left_side_ads.php'; ?>
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\gym1.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\gym2.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <!-- <div class="carousel-item">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>Iron Pulse Fitness Studio</h3>
                            <p class="product-title h5 mt-1"> Personalized Training for Every Fitness Level</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        Iron Pulse Fitness Studio in Kakinada is a modern gym equipped with advanced fitness machines and a motivating atmosphere. Whether you're a beginner or a seasoned athlete, our certified trainers help you achieve your health and fitness goals through personalized workout plans, strength training, cardio sessions, and group classes. With flexible membership options and hygienic facilities, Iron Pulse is your destination for a fit and active lifestyle.



                        </h6>
                      `  <!-- <h6>
                            We use high-quality products and the latest techniques to enhance your natural beauty while maintaining the health of your hair and skin. Whether you're looking for a simple touch-up or a complete transformation, Groom 9 saloon is your destination for premium beauty care. Let us pamper you with our exceptional services and bring out the best version of you.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Treadmill</span>
                                <span class="price"> ₹1,00,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Multi-Gym Machine</span>
                                <span class="price">₹1,20,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Dumbbells Set (2–30kg)</span>
                                <span class="price"> ₹15,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Cross Trainer</span>
                                <span class="price">₹60,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Exercise Bike</span>
                                <span class="price"> ₹40,000 </span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">Bench Press Station</span>
