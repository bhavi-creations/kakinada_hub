...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to TheToyTales Hub – Toys & Learning Kits</h1>
        <h5 class="text-center">Educational & Learning Toys</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\toyslearning1.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\toyslearning2.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <!-- <div class="carousel-item">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>TheToyTales Hub</h3>
                            <p class="product-title h5 mt-1">Puzzle & Creativity Kits</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        ToyTales Hub is a curated destination for high-quality educational and recreational toys designed to boost cognitive development, creativity, and motor skills in children. The store focuses on age-appropriate, screen-free learning options that blend fun with early education. Whether it's basic ABC blocks or advanced science kits, ToyTales Hub ensures every product is safe, non-toxic, and approved by child development specialists.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Magnetic Building Tiles – 40 pcs</span>
                                <span class="price">₹1,200</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Solar System DIY Model Kit</span>
                                <span class="price"> ₹1,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Kids Study Table with Chair Set</span>
                                <span class="price"> ₹5,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Toy Storage Box  </span>
                                <span class="price"> ₹1,300
                                </span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Animal World Puzzle Set (3 in 1)</span>
                                <span class="price">₹350</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                ABC Learning Train – Pull Along Toy </span>
