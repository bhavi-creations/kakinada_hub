...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The Skincare Hospital</h1>
        <h5 class="text-center">Advanced Skin & Aesthetic Care Solutions</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            ...
                            <p class="product-title h5 mt-1">Expert Dermatologists for All Skin Types</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                            Our Skincare Hospital offers advanced dermatology services designed to treat all types of skin concerns, from medical conditions to cosmetic enhancements. With state-of-the-art equipment and experienced dermatologists, we focus on personalized treatments that deliver visible results while ensuring safety and comfort. Whether you're looking to manage acne, reduce signs of aging, or rejuvenate your skin, our holistic approach brings lasting skin health and confidence.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Acne Scar Removal (Laser) </span>
                            ...
                            <div class="menu-item">
                                <span class="food-name"> Anti-Aging Facial (Medi Facial)</span>
                                <span class="price">₹2000</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                Wart & Mole Removal </span>
