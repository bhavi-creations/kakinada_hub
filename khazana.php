...
<section class=" bg_section responsive_section">
    <div class="container">
        ...
        <div class="text-center   ">
            <h1>Welcome to The khazana  Jewellery</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets/img/test/k1.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/img/test/k2.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/img/test/k3.png" class="img-fluid  d-block w-100" alt="...">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        Khazana is a well-established jewelry brand in India, known for its impeccable craftsmanship and vast collection of gold, diamond, platinum, and gemstone jewelry. With its roots deeply embedded in Indian culture, Khazana Jewelry has earned a reputation for offering high-quality, exquisite jewelry that caters to diverse tastes and occasions.

                      </h6>

                       <h6>
                       Since its inception in 1989, Khazana has become a household name, offering a wide range of jewelry collections, from traditional designs to contemporary styles. Their commitment to providing customers with a seamless and trustworthy shopping experience has made them a preferred choice among jewelry buyers.
