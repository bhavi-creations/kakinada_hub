...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The CycleCraze Accessories</h1>
        <h5 class="text-center">Smart Accessories for Safe and Smooth Cycling</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\accessries2.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <!-- <div class="carousel-item">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>CycleCraze Accessories</h3>
                            <p class="product-title h5 mt-1">Gear Up for Every Ride</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        CycleCraze Accessories is your one-stop destination for high-quality bicycle accessories designed for safety, comfort, and performance. Whether you're a city commuter, weekend explorer, or mountain trail enthusiast, our range includes everything from safety gear to performance upgrades. We prioritize durability, innovation, and rider satisfaction, offering products that match every type of cycling adventure.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Adjustable Bottle Holder</span>
                                <span class="price">₹250</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Puncture Repair Kit (Mini)</span>
                            ...
                            <div class="menu-item">
                                <span class="food-name">
                                Mobile Holder with Waterproof Cover </span>
                                <span class="price"> ₹500
                                </span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Handlebar Grip</span>
                                <span class="price">₹300</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                Chain Lubricant</span>
