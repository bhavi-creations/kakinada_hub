...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The NutriCore Wellness</h1>
        <h5 class="text-center">Fuel Your Body the Right Way</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\diet1.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\diet2.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <!-- <div class="carousel-item">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>NutriCore Wellness</h3>
                            <p class="product-title h5 mt-1">Nutrition That Supports Every Goal</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                            NutriCore Wellness is your dedicated partner in achieving optimal health through balanced nutrition and scientifically formulated supplements. Whether you're an athlete looking to improve performance, someone on a weight management journey, or just aiming to live healthier, we offer expert-approved diet plans, protein powders, vitamins, and health foods. Our products are sourced with quality in mind and tailored for every lifestyle and goal.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Whey Protein (1kg, Chocolate)</span>
                                <span class="price">₹1500</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Multivitamin Capsules (60 count) </span>
                                <span class="price"> ₹500</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Omega-3 Fish Oil</span>
                                <span class="price"> ₹650</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Meal Replacement Shake  </span>
                                <span class="price"> ₹850
                                </span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">BCAA Powder</span>
                                <span class="price">₹1,200</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                Herbal Green Tea </span>
