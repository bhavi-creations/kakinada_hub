...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The Physiotherapy Hospital</h1>
        <h5 class="text-center">Pain Management & Mobility Restoration</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\Physiotherapy12.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\Physiotherapy11.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <!-- <div class="carousel-item">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>Physiotherapy Hospital</h3>
                            <p class="product-title h5 mt-1">Rehabilitation & Recovery Center</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                            At our Physiotherapy Hospital, we specialize in restoring your mobility and reducing pain through advanced physiotherapy techniques. Whether you're recovering from surgery, managing a chronic condition, or dealing with an injury, our expert physiotherapists design personalized treatment plans to help you regain strength, flexibility, and overall function. We focus on holistic rehabilitation, utilizing physical therapy, exercise therapy, and specialized treatments to help you feel your best.

                            <br>
                            Our services range from orthopedic physiotherapy to sports injury rehabilitation and post-operative care. With a patient-first approach, we ensure that each treatment is tailored to meet your specific needs and goals, guiding you through every step of your recovery journey.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Initial Consultation & Assessment</span>
                                <span class="price">₹1000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                    Sports Injury Rehabilitation </span>
                            ...
                            <div class="menu-item">
                                <span class="food-name">
                                    Stroke Treatment & Monitoring </span>
                                <span class="price"> ₹1,500
                                </span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name"> Manual Therapy </span>
                                <span class="price">₹2,000</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                    Dry Needling Therapy </span>
                                <span class="price"> ₹3,000 </span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                    Ultrasound Therapy </span>
                                <span class="price"> ₹1,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                    Spinal Therapy (Neck/Back) </span>
