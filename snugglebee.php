...
<section class=" bg_section responsive_section">
    <div class="container">
        ...
        <div class="text-center   ">
            <h1>Welcome to The SnuggleBee Essentials</h1>
            <h5>Baby Hygiene & Grooming</h5>
        </div>
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                    <div class="col-md-8 col-12">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\babycare1.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\babycare2.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>The SnuggleBee </h3>
                            <p class="product-title h5 mt-1">Feeding Accessories</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        SnuggleBee Essentials is your trusted neighborhood destination for high-quality baby care products and essentials. Focused on newborn safety, comfort, and gentle care, this store offers a handpicked collection of daily use items that meet pediatric safety standards. From nourishing lotions to feeding accessories, SnuggleBee ensures that everything your baby touches is pure, safe, and comforting.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Organic Baby Body Lotion (200ml)</span>
                                <span class="price">₹450</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Hypoallergenic Baby Soap – Pack of 2</span>
                                <span class="price">₹199</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">BPA-Free Feeding Bottle </span>
                                <span class="price"> ₹400</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Disposable Diaper Pack </span>
                                <span class="price">₹750</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Natural Baby Massage Oil</span>
                                <span class="price">₹350</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">Silicone Teether Toy – BPA Free</span>
