...
$successMsg = isset($_GET['success']) ? "Offers item added successfully!" : '';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (move_uploaded_file($imageTmp, $uploadPath)) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            header("Location: add_home_offers.php?success=1");
            exit();
        } else {
        ...
        <div id="content">
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Add Home Page Offers</h1>
                    <a href="view_home_offers.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                        <i class="fa-regular fa-eye"></i> View Offers Posts
                    </a>
                </div>
