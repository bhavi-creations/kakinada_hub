    ...
    <div id="content" class="container-fluid">
      ...
      <form method="GET" class="flex-wrap gap-2 form_view_company_ads">
        ...
        <select name="ad_position">
          ...
          <option value="all deviceads" <?= (isset($_GET['ad_position']) && $_GET['ad_position'] === 'all deviceads') ? 'selected' : '' ?>>All Device Ads</option>
          <option value="mobile pop up ads" <?= (isset($_GET['ad_position']) && $_GET['ad_position'] === 'mobile pop up ads') ? 'selected' : '' ?>>Mobile Pop Up Ads</option>
        </select>
        ...
        <table class="table table-striped table-bordered align-middle">
          ...
          <tbody>
            ...
            if (!empty($position)) {
              ...
              $whereClauses[] = "LOWER(a.ad_position) = LOWER('$safe_position')";
            }
