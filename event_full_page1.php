...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag"> Holi Event</h1>
            ...
            <div class="col-lg-8 col-12">
                <div class="row scrollable-list">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets/img/self_images/holi (1).jpeg" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/img/self_images/holi (2).jpeg" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/img/self_images/holi (3).jpeg" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-12  my-2 movie_title_card">
                        ...
                        <div class="product-content">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <h3 class="movie-value">Halcyon times </h3>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class=" col-12 py-3">
                        ...
                        <h6 class="p-gradient">
                            Halcyon Times in Kakinada hosted a Holi celebration on March 14th,
                            featuring DJ Kishan, DJ Palve, and DJ Shyam. The event, described as the biggest Holi party in Kakinada,
                            took place at their open arena. The celebration included music, vibrant colors, and a festive atmosphere.
                            The event was promoted through social media, with SM Networks62 serving as the media partner.
                            Attendees were encouraged to experience the festival of colors and beats.
                            The organizers emphasized the unforgettable experience and the energy of the event. </h6>
                        <h2 class="logo_title_color">About the Venue</h2>
                        <h6 class="p-gradient">
                            Halcyon Times Located in Nagamallithota Junction, Kakinada, it is a 3-star hotel offering accommodation and various amenities.
                            include,WiFi, air conditioning, in-house restaurant, refined bar, swimming pool, conference rooms, 24/7 concierge service, fitness center, and spa facilities.
                            It appears to be a club offering sports facilities such as tennis, squash, football, and billiards.
                            It also has a restaurant and bar.
                            The Halcyon Times Club is listed as a "Luxury Club" with facilities like a swimming pool, gym, and open-air theatre.
                            In these Halcyon Times they celebrate biggest fest like Holi,New year.</h6>
