...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The ENT Hospitals</h1>
        <h5 class="text-center">Expert ENT Specialists & Advanced Diagnostics</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3> ENT Hospitals</h3>
                            <p class="product-title h5 mt-1">Comprehensive Ear, Nose & Throat Care</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                            ENT (Ear, Nose, and Throat) hospitals specialize in diagnosing and treating disorders related to the ear, nose, throat, head, and neck. These hospitals are equipped with advanced diagnostic tools and experienced ENT specialists to handle everything from minor infections to complex surgeries
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Ear Wax Removal</span>
                                <span class="price">₹1,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Sinus Surgery (FESS) </span>
                            ...
                            <div class="menu-item">
                                <span class="food-name">
                                Hearing Test (Audiometry)</span>
                                <span class="price"> ₹1,000
                                </span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name"> Tympanoplasty (Ear Drum Surgery) </span>
                                <span class="price">₹50,000</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                Septoplasty (Deviated Nasal Septum) </span>
                                <span class="price"> ₹50,000 </span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                    Cochlear Implant (partial cost covered) </span>
                                <span class="price"> ₹7,00,000</span>
                            </div>
                            <!-- <div class="menu-item">
                                <span class="food-name">
