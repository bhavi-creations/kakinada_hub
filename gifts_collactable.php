                ...
                <div class="row my-5 p-3">
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Engraved Wooden Keepsake Box

                                </span>
                                <span class="price"> $29.99</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Personalized Name Necklace </span>
                                <span class="price"> $39.99</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Handmade Scented Candles (Set of 3) </span>
                                <span class="price"> $24.99</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Vintage Pocket Watch </span>
                            ...
                            <div class="menu-item">
                                <span class="food-name">Crystal Glass Figurines </span>
                            ...
                            <div class="menu-item">
                                <span class="food-name">Limited Edition Collectible Coins </span>
                    ...
                    <div class="col-md-8 col-12">
                        <div class="review-container">
                            ...
                            <div class="review">
                                ...
                                <p class="review-text">
                                    "Absolutely love the variety of gifts available!.
                                    <span class="hidden-text">Perfect for any occasion."</span>
                                </p>
                            ...
                            <div class="review">
                                ...
                                <p class="review-text">
                                High-quality and unique items. The packaging
                                 <span class="hidden-text"> was also beautiful!"</span>
                                </p>
                                <p class="view-more" onclick="toggleText(this)">Read More</p>
                                <p class="view-images" onclick="toggleImages(this)">View Images</p>
                                <div class="review-images">
                            ...
                            <div class="review">
                                ...
                                <p class="review-text">
                                    ...
                                    <span class="hidden-text">  Highly recommend!"</span>
                                </p>
                                <p class="view-more" onclick="toggleText(this)">Read More</p>
                                <p class="view-images" onclick="toggleImages(this)">View Images</p>
                                <div class="review-images">
