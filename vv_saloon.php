    ...
    <section>
        <div class="container">
            ...
            <div class="text-center   ">
                <h1>Welcome to The V & V saloon</h1>
                <h5>Experience Luxury & Elegance at V & V saloon</h5>
            </div>
            <div class="row">
                <div class="col-lg-9 col-12">
                    ...
                    <div class="row my-5 p-3">
                        <div class="col-md-8 col-12 ">
                            <h6>
                            V & V saloon offers a luxurious and relaxing experience where beauty meets expertise. With a team of skilled professionals, we provide a wide range of services, including hair styling, skincare, bridal makeovers, and personalized beauty treatments. Our salon is designed to create a serene atmosphere, ensuring every client leaves feeling refreshed and confident.


                            </h6>
                            <h6>
                            We use high-quality products and the latest techniques to enhance your natural beauty while maintaining the health of your hair and skin. Whether you're looking for a simple touch-up or a complete transformation, V & V saloon is your destination for premium beauty care. Let us pamper you with our exceptional services and bring out the best version of you.
