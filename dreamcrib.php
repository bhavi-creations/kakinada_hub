...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The DreamCrib Studio</h1>
        <h5 class="text-center">Luxury Baby Cribs & Custom Designs</h5>
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\woodendesigner1.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\woodendesigner2.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <!-- <div class="carousel-item">
...
2
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>DreamCrib Studio</h3>
                            <p class="product-title h5 mt-1">Comfort-First Bedding & Sleep Sets</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        DreamCrib Studio is your trusted destination for elegant, ergonomic, and safe sleeping solutions for babies. From handcrafted designer cribs to cozy bedding sets, every product is crafted with love and detail. The store emphasizes comfort, aesthetics, and international safety standards, making it the perfect choice for new parents seeking quality and style.


                            <br>

                            Whether you’re setting up a dreamy nursery or looking for sleep accessories that support a restful routine, DreamCrib Studio combines functionality with sophistication to create the perfect sleep environment for your little one.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Convertible Wooden Crib </span>
                                <span class="price">₹15000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Organic Cotton Bedding Set  </span>
                                <span class="price"> ₹3800</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Mosquito Net with Canopy Frame</span>
                                <span class="price"> ₹1650</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Crib Mobile – Soothing Night Light & Music </span>
                                <span class="price"> ₹1850
                                </span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Mattress with Waterproof Protector</span>
                                <span class="price">₹2500</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                Baby Sleep Positioner Pillow Set</span>
