...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The TinyNest World</h1>
        <h5 class="text-center">Comfort Meets Style in Every Corner</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\tinynest1.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\tinynest2.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <!-- <div class="carousel-item">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>Skincare Hospital</h3>
                            <p class="product-title h5 mt-1">Furniture Made for Growing Dreams</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        TinyNest World brings modern, safe, and ergonomic furniture solutions for babies and kids. Our furniture is designed with child safety in mind, using non-toxic paints, rounded corners, and sturdy builds. From cribs to compact study desks, our products are crafted to fit into both cozy apartments and spacious homes. Our designs blend aesthetics with functionality, perfect for today’s parents and tomorrow’s dreamers.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Convertible Crib with Storage Drawer </span>
                                <span class="price">₹12,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Foldable Baby High Chair</span>
                            ...
                            <div class="menu-item">
                                <span class="food-name"> Rocking Chair for Toddlers</span>
                                <span class="price">₹2150</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                Wall-Mounted Changing Table </span>
