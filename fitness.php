...
<section class=" bg_section responsive_section">
    <div class="container">
        ...
        <div class="text-center   ">
            <h1>Welcome to The ProActive Sports & Fitness</h1>
            <h5>Premium Fitness Equipment for Home & Gym
            </h5>
        </div>
        <div class="row">
        ...
        <?php include 'left_side_ads.php'; ?>
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\fitness2.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>The ProActive Sports & Fitness</h3>
                            <p class="product-title h5 mt-1">Affordable Wellness & Recovery Tools
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        ProActive Sports & Fitness is your one-stop destination in Kakinada for high-quality sports gear and fitness equipment. Whether you're a beginner starting your fitness journey, an athlete, or setting up a home gym, we provide reliable, branded equipment at competitive prices. We cater to individual fitness enthusiasts, gyms, schools, and sports academies, ensuring performance, safety, and durability with every product.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">	Treadmill (Motorized)

                                </span>
                                <span class="price"> ₹35,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Dumbbells (10 kg pair) </span>
                                <span class="price"> 	₹1,200</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Badminton Racket Set </span>
                                <span class="price"> ₹950</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Resistance Bands (Set)</span>
                                <span class="price"> 	₹600</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Gym Bench (Adjustable) </span>
                                <span class="price"> ₹4,500</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">Football (Standard Size) </span>
