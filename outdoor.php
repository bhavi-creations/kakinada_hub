...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The CampTrail Outfitterss</h1>
        <h5 class="text-center">Adventure-Ready Brands You Can Trust</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\outdoorcamping1.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\outdoorcamping2.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <!-- <div class="carousel-item">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>CampTrail Outfitters</h3>
                            <p class="product-title h5 mt-1">All-in-One Camping Equipment Store</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        Welcome to your one-stop destination for all things outdoor and adventure. Our store is dedicated to providing high-quality camping, trekking, and hiking gear for nature enthusiasts of all levels. Whether you're planning a weekend getaway or a full-blown wilderness expedition, you'll find everything you need—from durable tents and all-weather sleeping bags to compact cookware, backpacks, hiking boots, and safety gear.



                            <br>
                            We believe that the right equipment can turn any outdoor trip into an unforgettable experience. That's why we offer reliable products, expert guidance, and a commitment to helping you explore the great outdoors with confidence and comfort.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">2-Person Tent</span>
                            ...
                            <div class="menu-item">
                                <span class="food-name"> Trekking Pole (Pair)</span>
