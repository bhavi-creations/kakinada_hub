...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The LittleWonders PlayStore</h1>
        <h5 class="text-center">Ride-On Toys & Slides</h5>
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\indoorequimentbaby.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\indoorequimentbaby1.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <!-- <div class="carousel-item">
...
2
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>LittleWonders PlayStore</h3>
                            <p class="product-title h5 mt-1">Indoor Activity Centersl</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                            LittleWonders PlayStore is a vibrant space dedicated to inspiring active, imaginative, and safe play for kids of all ages. Specializing in high-quality indoor and outdoor equipment, the store provides a curated selection of toys and play structures that support physical growth and mental stimulation.

                            <br>

                            Whether you’re designing a playroom, setting up a garden swing, or buying an educational activity center, LittleWonders offers safe, durable, and colorful products that bring joy to childhood. All equipment is child-safe, weather-resistant, and designed with ergonomic and sensory development principles in mind.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">Indoor Climber & Slide Combo Set</span>
                                <span class="price">₹1500</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Kids Ball Pit with 100 Balls </span>
                                <span class="price"> ₹500</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Wooden Rocking Horse</span>
                                <span class="price"> ₹650</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Plastic Seesaw (2-Seater) </span>
                                <span class="price"> ₹850
                                </span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">Foldable Play Tent – Cartoon Print</span>
                                <span class="price">₹1,200</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                Jumbo Slide (5ft)</span>
