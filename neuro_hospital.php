...
<section class="bg_section responsive_section">
    <div class="container ">
        <h1 class="text-center gradient_text_color spacing_for_htag">
            Welcome to The Neuro Hospitals</h1>
        <h5 class="text-center">Expert Care for Brain & Spine Disorders</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-12">
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets\img\service _inside_images\hospitals5.png" class="  img-fluid  d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets\img\service _inside_images\hospitals7.png" class="img-fluid d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                    ...
                    <div class="col-md-4 col-12 p-3">
                        <div class="product-content">
                            <h3>Neuro Hospital</h3>
                            <p class="product-title h5 mt-1">Advanced Neurology & Neurosurgery Services</p>
                ...
                <div class="row my-5 p-3">
                    <div class="col-md-8 col-12 ">
                        <h6>
                        Neuro hospitals in Kakinada offer specialized treatment for conditions related to the brain, spinal cord, nerves, and muscles. These hospitals are equipped with advanced diagnostic tools and led by experienced neurologists and neurosurgeons. From stroke management to spine surgery, they provide both emergency and long-term neurological care.


                            <br>
                            Patients receive compassionate attention, personalized treatment plans, and access to 24/7 critical care units designed for neurological emergencies.
                    ...
                    <div class="col-md-4 col-12  ">
                        ...
                        <div class="menu-container">
                            <div class="menu-item">
                                <span class="food-name">MRI Brain Scan </span>
                                <span class="price">₹5000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                EEG (Electroencephalogram) </span>
                                <span class="price"> ₹1,500</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Nerve Conduction Study (NCS)</span>
                            ...
                            <div class="menu-item">
                                <span class="food-name"> Spine Surgery </span>
                                <span class="price">₹150000</span>
                            </div>

                            <div class="menu-item">
                                <span class="food-name">
                                Brain Tumor Surgery </span>
                                <span class="price"> ₹3,00,000 </span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Parkinson’s Disease Management </span>
                                <span class="price"> ₹10,000</span>
                            </div>
                            <div class="menu-item">
                                <span class="food-name">
                                Epilepsy Diagnosis & Treatment </span>
